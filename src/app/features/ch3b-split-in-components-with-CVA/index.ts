...
import { Ex33MultistepFormsWithCVAComponent } from './ex33-multistep-forms-with-CVA.component';

export const COMPONENTS = [
  Ex31SplitWithCVAComponent,
  Ex32SplitWithCVAAndTemplateDrivenComponent,
  Ex33MultistepFormsWithCVAComponent,
  FormStepComponent,
